        ...
        <div name="home" className="w-full h-screen">
            <div className="max-w-screen-lg mx-auto flex flex-col items-center space-around h-full px-4 md:flex-row">
                <div data-aos="fade-down" className="flex mt-20 sm:overflow-x-hidden flex-col justify-center items-center h-full basis-1/2">
                    ...
                    <h3 className="font-bold text-xl"> I am <Fade className="text-red-500" delay={1e3} cascade damping={1e-1}>
                    ...
                    <div>
                        <button className="flex group justify-center items-center  w-fit my-2 py-3 px-6 rounded-md bg-gradient-to-r from-sky-400 to-cyan-800 cursor-pointer">
