      ...
      return (
            <figure className="p-4 border border-black/10 shadow-sm dark:border-white/10 rounded-xl transform transition duration-500 hover:scale-105">
                  ...
                  <figcaption className="pt-4">
                        ...
                        <p className="text-[#575A6E] text-sm mb-2 text-justify">{project.overview.slice(0, 80)}...</p>

                        <Link
                              className="bg-[#f93a76] text-[#fff] rounded-lg py-2 px-5 flex items-center justify-center gap-2  text-sm"
